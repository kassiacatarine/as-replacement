      ...
      <div class="col">
        <form action="/lesson/new" method="POST">
          <div class="form-group">
            ...
            <input value="${(aulaAtual.titulo)!}" name="titulo" type="text" class="form-control" id="titulo" required>
          </div>
          <div class="form-group">
            <label for="data-pagamento">Data:</label>
            <div class="input-group date" data-date-format="dd/mm/yyyy">
              <input value="${(aulaAtual.data?date?string("dd/MM/yyyy"))!}" name="data" id="data" type="text" class="form-control" placeholder="dd/mm/yyyy" required>
          ...
          <div class="form-group">
            ...
            <input value="${(aulaAtual.aulas)!}" name="aulas" type="number" class="form-control" id="aulas" required>
          </div>
          <div class="form-group">
